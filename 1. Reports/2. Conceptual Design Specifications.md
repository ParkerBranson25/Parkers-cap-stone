...
with ANSI/OPEI safety and performance requirements for golf cars [1]. Additionally, it is imperative that the installation process of the retrofit kit is deemed safe, in 
order to keep those that are working to implement these retrofit kits are kept safe.
